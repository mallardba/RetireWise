      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center pb-2">
            <span className="text-sm text-gray-600 dark:text-gray-400">{t('paycheck.without401k')}</span>
          ...
          <div className="flex justify-between items-center text-sm border-l-2 border-primary pl-3">
            <span className="text-gray-600 dark:text-gray-400">{t('paycheck.yourContribution')}</span>
          ...
          {impact.taxSavings >= 0 && (
            <div className="flex justify-between items-center text-sm border-l-2 border-success pl-3">
              <span className="text-gray-600 dark:text-gray-400">{t('paycheck.taxSavings')}</span>
          ...
          <div className="pt-3 border-t-2 border-gray-200 dark:border-gray-700">
            <div className="flex justify-between items-center">
              <span className="text-base font-medium text-gray-900 dark:text-white">{t('paycheck.actualTakeHome')}</span>
